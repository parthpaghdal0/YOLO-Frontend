...
import { selectActiveGameId, selectIsPriceFeedConnected, selectIsRoundEnded } from 'redux/selectors'
...
export const GameHeader = ({ gridArea, onItemClick }) => {
  ...
  return (
    <HeaderNav id='HeaderNav' gridArea={gridArea}>
      <LeftArea>
        <YoloLogo collection='yolorekt' name={showLoading ? 'LoadingMoon' : 'moon'} dimension='34px' />
        <AssetsSelector />
